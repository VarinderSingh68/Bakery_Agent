...
async def google_browser_login(
    ...
    try:
        ...
        # Consolidate user lookup and creation through ensure_sql_user
        user_payload = {
            "email": email,
        ...
        # ensure_sql_user will find an existing user by email or create a new one.
        # It correctly handles datetime objects, solving the TypeError.
        user = await ensure_sql_user(db, user_payload)
